...
object TLog {
    ...
    fun init(context: Context) { // 在Application中初始化
        LOG_FILE_PATH = RxFileTool.getRootPath(context)!!.path + File.separator + context.packageName + File.separator + "Log"
//        LOG_FILE_PATH = (context.getExternalFilesDir(null)?.absolutePath) + File.separator + context.packageName + File.separator + "Log";
        LOG_FILE_NAME = "TLog_"
    }
