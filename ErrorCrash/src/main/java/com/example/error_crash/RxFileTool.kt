...
import com.example.error_crash.RxConstTool.KB
import com.example.error_crash.RxDataTool.Companion.byte2FitSize
import com.example.error_crash.RxDataTool.Companion.encryptMD5File2String
...
class RxFileTool {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun getRootPath(context: Context): File {
