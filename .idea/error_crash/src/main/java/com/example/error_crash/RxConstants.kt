...
object RxConstants {
    ...
    //默认保存下载文件目录
    val DOWNLOAD_DIR = RxFileTool.rootPath.toString() + File.separator + "Download" + File.separator + RxTool.getContext().packageName + File.separator
    ...
    //图片原始路径
    val PICTURE_ORIGIN_PATH = RxFileTool.rootPath.toString() + File.separator + RxTool.getContext().packageName + File.separator + "Picture" + File.separator + "Origin" + File.separator

    //图片压缩路径
    val PICTURE_COMPRESS_PATH = RxFileTool.rootPath.toString() + File.separator + RxTool.getContext().packageName + File.separator + "Picture" + File.separator + "Compress" + File.separator

    //默认导出文件目录
    val EXPORT_FILE_PATH = RxFileTool.rootPath.toString() + File.separator + RxTool.getContext().packageName + File.separator + "ExportFile" + File.separator
